...
class AppLocalizations {
  ...
  static const _strings = <String, Map<AppLocale, String>>{
    ...
    'api_credentials': {AppLocale.en: 'API Credentials', AppLocale.zh: 'API 凭证'},
    'model_mapping': {AppLocale.en: 'Model Mapping', AppLocale.zh: '模型映射'},
    'model_mappings': {AppLocale.en: 'Model Mappings', AppLocale.zh: '模型映射'},
    'proxy_pool': {AppLocale.en: 'Proxy Pool', AppLocale.zh: '代理池'},
    'proxy_create': {AppLocale.en: 'Create Proxy', AppLocale.zh: '创建代理'},
    'proxy_edit': {AppLocale.en: 'Edit Proxy', AppLocale.zh: '编辑代理'},
    'proxy_url': {AppLocale.en: 'Proxy URL', AppLocale.zh: '代理地址'},
    'proxy_type': {AppLocale.en: 'Proxy Type', AppLocale.zh: '代理类型'},
    'proxy_auth_type': {AppLocale.en: 'Auth Type', AppLocale.zh: '认证类型'},
    'proxy_test': {AppLocale.en: 'Test Proxy', AppLocale.zh: '测试代理'},
    'proxy_test_success': {AppLocale.en: 'Proxy test passed', AppLocale.zh: '代理测试通过'},
    'proxy_test_failed': {AppLocale.en: 'Proxy test failed', AppLocale.zh: '代理测试失败'},
    'proxy_confirm_delete': {AppLocale.en: 'Delete proxy {name}?', AppLocale.zh: '删除代理 {name}？'},
    'proxy_empty': {AppLocale.en: 'No proxies', AppLocale.zh: '暂无代理'},
    'proxy_empty_hint': {AppLocale.en: 'Create a proxy to route site traffic', AppLocale.zh: '创建代理以转发站点流量'},
    'proxy_references': {AppLocale.en: '{count} references', AppLocale.zh: '{count} 个引用'},
    'credential_confirm_delete': {AppLocale.en: 'Delete credential {name}?', AppLocale.zh: '删除凭证 {name}？'},
    'credential_verify': {AppLocale.en: 'Verify', AppLocale.zh: '验证'},
    'credential_select_probes': {AppLocale.en: 'Select probes', AppLocale.zh: '选择探针'},
    'credential_run_verify': {AppLocale.en: 'Run verification', AppLocale.zh: '运行验证'},
    'credential_export_cli': {AppLocale.en: 'Export CLI Config', AppLocale.zh: '导出 CLI 配置'},
    'credential_config': {AppLocale.en: 'Config', AppLocale.zh: '配置'},
    'credential_copy': {AppLocale.en: 'Copy', AppLocale.zh: '复制'},
    'credential_create': {AppLocale.en: 'Create Credential', AppLocale.zh: '创建凭证'},
    'credential_edit': {AppLocale.en: 'Edit Credential', AppLocale.zh: '编辑凭证'},
    'credential_api_type': {AppLocale.en: 'API Type', AppLocale.zh: 'API 类型'},
    'credential_healthy': {AppLocale.en: 'Healthy', AppLocale.zh: '健康'},
    'credential_degraded': {AppLocale.en: 'Degraded', AppLocale.zh: '降级'},
    'credential_unhealthy': {AppLocale.en: 'Unhealthy', AppLocale.zh: '异常'},
    'credential_unknown': {AppLocale.en: 'Unknown', AppLocale.zh: '未知'},
    'credential_empty': {AppLocale.en: 'No credentials', AppLocale.zh: '暂无凭证'},
    'credential_empty_hint': {AppLocale.en: 'Add API credentials for verification and CLI export', AppLocale.zh: '添加 API 凭证用于验证和 CLI 导出'},
    'mapping_confirm_delete': {AppLocale.en: 'Delete mapping {name}?', AppLocale.zh: '删除映射 {name}？'},
    'mapping_create': {AppLocale.en: 'Create Mapping', AppLocale.zh: '创建映射'},
    'mapping_edit': {AppLocale.en: 'Edit Mapping', AppLocale.zh: '编辑映射'},
    'mapping_pattern': {AppLocale.en: 'Pattern', AppLocale.zh: '匹配模式'},
    'mapping_match_type': {AppLocale.en: 'Match Type', AppLocale.zh: '匹配类型'},
    'mapping_target_model': {AppLocale.en: 'Target Model', AppLocale.zh: '目标模型'},
    'mapping_priority': {AppLocale.en: 'Priority', AppLocale.zh: '优先级'},
    'mapping_empty': {AppLocale.en: 'No model mappings', AppLocale.zh: '暂无模型映射'},
    'mapping_empty_hint': {AppLocale.en: 'Create mappings to rewrite requested model names', AppLocale.zh: '创建映射以改写请求的模型名称'},
